                    ...
                    <div className="text-center mt-8">
                        ...
                        <div className="mt-8 inline-block">
                            <a
                                ...
                                className="relative lg:text-[2.2vw] font-bold opacity-90 transition-transform duration-100 hover:scale-105 fadeUp inline-block"
                            >
                                Kista Nod, Borgarfjordsgatan 12
                                <MapPin className="absolute -top-4 -right-6 rotate-45 fadeUp" />
                            </a>
                            <div className="block text-sm sm:text-base lg:text-[1.4vw] opacity-95 fadeUp mt-4">
