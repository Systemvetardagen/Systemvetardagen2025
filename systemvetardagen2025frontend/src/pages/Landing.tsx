            ...
            <div className="overflow-hidden font-poppins">
                ...
                <div className="h-screen max-h-[1200px] w-screen gradient-background text-white flex flex-col items-center justify-evenly py-[15vh] min-w-[351px] font-poppins tracking-wide">
                    <div className="text-center mt-8">
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-5xl mb-8 font-semibold mt-6">
                    ...
                    <a
                        ...
                        className="relative lg:text-[1.5vw] font-bold opacity-90 mt-8 transition-transform duration-100 hover:scale-105"
                    >
                    ...
                    <NavLink to="/companies">
                        <button className="bg-none border-4 py-4 px-6 rounded-full text-xl font-bold mt-10">
                            {t('exhibitors')}
                        </button>
                    </NavLink>
                </div>
                ...
                <div className="w-screen px-[8vw] md:px-[15vw] lg:px-[20vw] py-[4vw] flex flex-col items-center justify-center gap-10 bg-background text-text text-center">
                    ...
                    <Partners />
                    <a href="/companies" className="w-full h-[200px] overflow-hidden relative rounded-3xl group">
                        <img
                    ...
                    <a href="/visit-info" className="w-full h-[200px] overflow-hidden relative rounded-3xl group">
                        <img
                    ...
                    <div className="bg-[#FFEAC9] rounded-3xl py-10 text-center flex flex-col gap-10 shadow-lg w-full">
                        ...
                        <div className="w-full flex flex-col gap-8 md:flex-row md:gap-0 justify-center">
                            {['before', 'during'].map((period) => (
                                <div className="flex flex-col px-6 max-w-md" key={period}>
                                    ...
                                    {['t1', 't2', 't3'].map((tip) => (
                                        <p className="text-lg mt-4 list-item text-left" key={tip}>
